      ...
      <nav id="nav-wrap">
        ...
        <a class="mobile-btn" href="#" title="Hide navigation">Hide navigation</a>
         ...
         <ul id="nav" class="nav">
           ...
           <li><a class="smoothscroll" href="#resume">Education & work</a></li>
           <li><a class="smoothscroll" href="#skills">Skills-projects</a></li>
           
            <li><a class="smoothscroll" href="#testimonials">testimonials</a></li>
            <li><a class="smoothscroll" href="#testimonials">contacts</a></li>
         </ul> <!-- end #nav -->
...
?>
         ...
         <div class="nine columns main-col">
            ...
            <div class="row">
               ...
               <div class="columns download">
                  <p>
                      <a href="README.md" class="button"><i class="fa fa-download"></i>More About Me</a>
                  </p>
               </div>
   ...
   <section id="resume">
      ...
      <!-- Education
      ----------------------------------------------- -->
      <div class="row education" style="background:burlywood;">
      ...
      <!-- Work
      ----------------------------------------------- -->
      <div class="row work" style="background-color:mistyrose">
      ...
      <!<div class="row skill">
         ...
         <div class="nine columns main-col">
            ...
            <p> My skills set contain a wide variety of Skills. But i will mention a few which are related to software engineering 
               as metioning all the skills would take more space in my portfolio. so, here are some of my skills
            </p>
        ...
        <div class="bars">
           ...
           <ul class="skills">
            ...
            <li><span class="bar-expand html5"></span><em>HTML5</em></li>
                  <li><span class="bar-expand jquery"></span><em>js</em></li>
          </ul>
   ...
   <section id="portfolio">
      ...
      <div class="row">
         ...
         <div class="twelve columns collapsed">
            ...
            <h1 style="font-size:50px">Check Out My PROJECTS.</h1>
